...
> = {
  ...
  param?: P;
  process?: (prev: ActionState[K] | undefined, ...args: P) => ActionState[K];
};
...
export type ReducerType<
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  P extends any[] | [any] = any[]
> = (state: GlobalState, action: ActionData<K, P>) => GlobalState;
...
export type ActionGetHandler<T extends Action> = (
  state: GlobalState
) => ActionState[T];
